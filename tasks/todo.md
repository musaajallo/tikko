...
F01–F29 complete on `main`. F28 shipped JSON + CSV; F28-xlsx deferred.
- **api 178/178** · **web 20/20** · **shared-types 11/11** · **mobile 14/14** = 223 tests
- `all-features.md` F20 + F21 + F22 + F23 + F24 + F25 + F26 + F27 + F28 + F29 all closed.
