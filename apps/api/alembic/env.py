...
# Pull the database URL from tikko.settings so the same env var
# (`TIKKO_DATABASE_URL`) drives both the app and migrations.
...
def do_run_migrations(connection: Connection) -> None:
    # `render_as_batch=True` makes alembic emit `op.batch_alter_table` for ALTERs,
    # which is required for SQLite (limited ALTER support) and harmless on Postgres.
